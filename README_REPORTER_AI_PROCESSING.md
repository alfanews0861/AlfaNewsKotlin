...
- Both functions use Gemini-3.5-Flash-Lite AI for high-quality output
...
Reporter/Citizen Submits News
   ...
   Appropriate Cloud Function called
           ↓
   AI Enhancement Applied (Gemini-3.5-Flash-Lite)
           ↓
...
### Model Used
- **Model Name**: `gemini-3.5-flash-lite` (PRO_MODEL)
...
4. **Consistent Quality**: Both types use high-quality AI (Gemini-3.5-Flash-Lite)
