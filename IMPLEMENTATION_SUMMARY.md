...
- **Features**:
  - Uses the same PRO_MODEL (gemini-3.5-flash-lite) for high-quality output
...
4. **Consistency**: Both flows use the same high-quality PRO_MODEL (Gemini-3.5-Flash-Lite)
...
- Both functions use `PRO_MODEL` (gemini-3.5-flash-lite) for quality
