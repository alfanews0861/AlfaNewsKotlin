...
Object.defineProperty(exports, "reprocessUnprocessedNewsHttp", { enumerable: true, get: function () { return news_handler_1.reprocessUnprocessedNewsHttp; } });
...
exports.triggerPushBroadcast = (0, https_1.onCall)(async (request) => {
    ...
    const isAdmin = ['ADMIN', 'EDITOR', '5', '5.0', '7', '7.0'].includes(senderRole) || senderDoc.data()?.role === types_1.UserRole.ADMIN || senderDoc.data()?.role === types_1.UserRole.EDITOR;
    if (!isAdmin) {
        throw new https_1.HttpsError('permission-denied', 'పుష్ నోటిఫికేషన్లు పంపే అనుమతి కేవలం అడ్మిన్లకు మాత్రమే ఉంది.');
    }
