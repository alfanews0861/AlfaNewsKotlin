...
exports.scheduleDailyAffiliateDeals = void 0;
 ...
 */
function signAmazonRequest(payload, accessKey, secretKey, region, host, target) {
...
async function fetchAmazonDeals(config) {
...
async function fetchFlipkartDeals(config) {
...
exports.scheduleDailyAffiliateDeals = (0, scheduler_1.onSchedule)({
    schedule: "0 3 * * *",
    ...
    for (const product of allProducts) {
        try {
            const aiResult = await (0, geminiService_1.processProductWithAI)(`${product.title} - Price: ${product.price} at ${product.source}`);
            if (aiResult) {
