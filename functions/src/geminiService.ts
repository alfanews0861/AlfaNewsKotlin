...
export const processSocialPostWithAI = async (
    ...
    const schema = {
        ...
        properties: {
            ...
            headline: { type: Type.STRING, description: "Step 1: 100% Pure Telugu headline in 6-8 words, single complete sentence" },
            content: { type: Type.STRING, description: "Step 1: 100% Pure Telugu journalistic news story (strictly 60-70 words, single paragraph) created from input regardless of input language" },
            ...
            headlineEn: { type: Type.STRING, description: "Step 2: English headline translated from Telugu headline (6-8 words)" },
