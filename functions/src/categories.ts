...
దశ 2.1: సీనియర్ ఎడిటర్ పూర్తి వార్త (SENIOR EDITOR FULL STORY - STRICTLY 200 TO 250 WORDS)
...
- నిబంధనలు (CRITICAL RULES FOR FULL STORY):
  1. పదాల పరిమితి: గరిష్టంగా 200 నుండి 250 తెలుగు పదాలు మాత్రమే ఉండాలి.
  ...
  3. కల్పితాలు వద్దు (NO HALLUCINATIONS): అసలు సమాచారంలో 150-200 పదాలే ఉంటే లేనిపోనివి ఊహించి రాయవద్దు. ఉన్న సమాచారాన్నే పరిశుభ్రమైన భాషలో, చక్కటి పేరాగ్రాఫ్‌లుగా రాయండి.
  ...
  6. చిన్న వార్తల నిబంధన (SHORT NEWS): ఒకవేళ మూల సమాచారం 70-80 పదాల లోపే ఉండి, వార్తలో ఇతర వివరాలు ఏమీ లేనప్పుడు, బలవంతంగా 200 పదాలు పూర్తి చేయడానికి లేనివి ఊహించవద్దు. అటువంటి చిన్న వార్తలకు fullStoryTe ను content కు సమానంగా ఉంచండి.
  ...
  "stories": [
    {
      ...
      "fullStoryTe": "పూర్తి వార్త - సీనియర్ ఎడిటర్ సమగ్ర కథనం (కచ్చితంగా 200-250 పదాలు, మూల భావం & వ్యక్తుల పేర్లు మిస్ కాకుండా)",
      "headlineEn": "English Headline (max 8-10 words)",
      "contentEn": "English Content (max 50-60 words)",
      "fullStoryEn": "Full English Story by Senior Editor (150-200 words)",
