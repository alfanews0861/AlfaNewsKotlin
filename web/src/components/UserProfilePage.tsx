  ...
  return (
    <div className="space-y-6 pb-24 relative animate-fade-in bg-gray-50 min-h-full pt-4 font-mallanna text-black">
      ...
      <div className="px-3 space-y-4">
        {/* Direct Reporter Desk Chat Button */}
        <div className="bg-white rounded-2xl shadow-sm border border-teal-100 overflow-hidden">
          <button
            onClick={() => onNavigate('messages')}
            className="w-full bg-gradient-to-r from-teal-50 via-emerald-50 to-teal-50 text-left p-4 flex justify-between items-center hover:from-teal-100 hover:to-emerald-100 transition"
          >
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-teal-700 text-white rounded-2xl flex items-center justify-center shadow-md text-xl">
                💬
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <span className="block font-bold text-teal-950 font-ramabhadra text-lg leading-tight">
                    రిపోర్టర్ డెస్క్ చాట్
                  </span>
                  {unreadMessagesCount > 0 && (
                    <span className="bg-red-600 text-white text-[10px] font-black px-2 py-0.5 rounded-full animate-pulse">
                      {unreadMessagesCount} కొత్తవి
                    </span>
                  )}
                </div>
                <span className="block text-xs font-bold text-teal-700">అడ్మిన్ డెస్క్‌తో ప్రత్యక్ష సంభాషణ (Direct Chat)</span>
              </div>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-600" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1-1.414 0z" clipRule="evenodd" />
            </svg>
          </button>
        </div>
